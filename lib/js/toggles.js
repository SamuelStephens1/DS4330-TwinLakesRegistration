document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('btn01Search').addEventListener('click', function () {
        ...
        if (zip && phone) {
            lookup();
            //do the checking of stuff here (checking if there are jsons returned, display or send popup to try again)
        } else {
    ...
    document.getElementById('btn02Lookup').addEventListener('click', function () {
        ...
        const county = document.getElementById(/*County Field*/).value;
