document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        // Event listener for "Information is Incorrect" button
        document.getElementById('btn04Corrections').addEventListener('click', function () {
            ...
            document.getElementById('txtCorrectEmail').value = ''; // Email is empty by default if not in confirmation
        ...
        // Event listener for "Confirm" button in the correction form
        document.getElementById('btn05Confirm').addEventListener('click', function () {
            // Update confirmation page fields with corrected values
            ...
            // Hide the correction form and show the confirmation page
            document.getElementById('divTicketCorrection').style.display = 'none';
            document.getElementById('divTicketConfirmation').style.display = 'block';
        });
    
        // Event listener for "Cancel" button in the correction form
        document.getElementById('btn05Cancel').addEventListener('click', function () {
            // Hide the correction form and go back to the confirmation page without saving changes
            document.getElementById('divTicketCorrection').style.display = 'none';
            document.getElementById('divTicketConfirmation').style.display = 'block';
        });
    });    
